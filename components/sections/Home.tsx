...
const Home = () => {
  return (
    <main className="relative min-h-screen w-full overflow-hidden flex flex-col items-center justify-center bg-gray-100">
      ...
      <div className="container mx-auto px-4 py-16 relative z-10 flex flex-col items-center">
        ...
        <BoxReveal duration={0.7}>
          <p className="text-xl md:text-2xl text-blue-600 mb-8 text-center">
